...
export default hopeTheme({
  ...
  locales: {
    ...
    "/": {
      ...
      sidebar: zhSidebar,
      footer:
        "年轻人的职责是平整土地，而非焦虑时光，做好三四月的事，在八九月自有答案。",
      displayFooter: true,
      blog: {
        description: "哥们的摸鱼小破站~",
        intro: "/intro.html",
      },
    },
  },
  ...
  plugins: {
    ...
    comment: {
      // Giscus评论系统配置
      provider: "Giscus",
      repo: "202210230530/blog-comments",
      repoId: "R_kgDOJcYfNg",
      category: "Announcements",
      categoryId: "DIC_kwDOJcYfNs4CWHEJ",
    },
    ...
    pwa: {
      ...
      msTile: {
        image: "/assets/icon/apple-icon.png",
        color: "#ffffff",
      },
      manifest: {
        name: "快乐摸鱼",
        short_name: "MoYuYu",
        description: "zzzzzxm的摸鱼小破站",
        icons: [
          {
            src: "/assets/icon/chrome-512-mask-icon.png",
            sizes: "512x512",
            purpose: "maskable",
            type: "image/png",
          },
          {
            src: "/assets/icon/chrome-192-mask-icon.png",
            sizes: "192x192",
            purpose: "maskable",
            type: "image/png",
          },
          {
            src: "/assets/icon/chrome-512-icon.png",
            sizes: "512x512",
            type: "image/png",
          },
          {
            src: "/assets/icon/chrome-192-icon.png",
            sizes: "192x192",
            type: "image/png",
          },
        ],
